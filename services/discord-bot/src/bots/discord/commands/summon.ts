...
import type { Client as NimaraClient } from '@proj-nimara/server-sdk'
import type { Discord } from '@proj-nimara/server-shared/types'
import type {
...
export class VoiceManager extends EventEmitter {
  ...
  constructor(client: DiscordClient, nimaraClient: NimaraClient) {
    super()
    this.client = client
    this.nimaraClient = nimaraClient
  }
