...
export class DiscordAdapter {
  private nimaraClient: NimaraClient
  ...
  constructor(config: DiscordAdapterConfig) {
    ...
    this.nimaraClient = new NimaraClient({
      name: 'discord-bot',
      possibleEvents: [
        'input:text',
        'input:text:voice',
      ...
      token: config.nimaraToken,
      url: config.nimaraUrl,
    })

    this.voiceManager = new VoiceManager(this.discordClient, this.nimaraClient)
  ...
  private setupEventHandlers(): void {
    ...
    this.nimaraClient.onEvent('ui:configure', async (event) => {
    ...
    this.nimaraClient.onEvent('input:text', async (event) => {
