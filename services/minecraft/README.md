# ⛏️ Minecraft agent player for [アイリ (NIMARA)](https://nimara.moeru.ai)

> [!NOTE]
>
> This project is part of the [Project アイリ (NIMARA)](https://github.com/moeru-ai/nimara), we aim to build a LLM-driven VTuber like [Neuro-sama](https://www.youtube.com/@Neurosama) (subscribe if you didn't!) if you are interested in, please do give it a try on [live demo](https://nimara.moeru.ai).
...
```bash
git clone https://github.com/moeru-ai/nimara.git
