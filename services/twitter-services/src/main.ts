...
import type { NimaraAdapter } from './adapters/nimara-adapter'
 ...
 */
async function cleanup(adapters: { nimara?: NimaraAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
 ...
 */
function setupShutdownHooks(adapters: { nimara?: NimaraAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
