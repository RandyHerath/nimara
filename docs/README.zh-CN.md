...
<p align="center">
  [<a href="https://discord.gg/TgQ3Cu2F7A">加入 Discord</a>] [<a href="https://nimara.moeru.ai">试试看</a>] [<a href="https://github.com/moeru-ai/nimara/blob/main/README.md">English</a>] [<a href="https://github.com/moeru-ai/nimara/blob/main/docs/README.ja-JP.md">日本語</a>]
</p>
...
>
> **如果你已经感兴趣了，为什么不来这里和大家打个招呼呢？[Would like to join part of us to build NIMARA?](https://github.com/moeru-ai/nimara/discussions/33)**
...
### 网页版 (也就是 [nimara.moeru.ai](https://nimara.moeru.ai) 的版本)
...
- [`tstl-plugin-reload-factorio-mod`](https://github.com/moeru-ai/nimara-factorio/tree/main/packages/tstl-plugin-reload-factorio-mod): 开发时支持热重载 Factorio 模组
