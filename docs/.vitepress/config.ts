...
export default defineConfig({
  ...
  head: [
    ...
    ['script', {
      'defer': 'true',
      'data-domain': 'nimara.moeru.ai',
      'data-api': 'https://nimara.moeru.ai/api/v1/page-external-data/submit',
      'src': 'https://nimara.moeru.ai/remote-assets/page-external-data/js/script.js',
    }],
    ['script', {}, `
      ;(function () {
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/moeru-ai/nimara/edit/main/docs/content/:path',
    },
  },
  srcDir: 'content',
  appearance: 'dark',
  ...
  vite: {
    resolve: {
      alias: {
        '@proj-nimara/stage-ui/components': resolve(join(import.meta.dirname, '..', '..', 'packages', 'stage-ui', 'src', 'components')),
