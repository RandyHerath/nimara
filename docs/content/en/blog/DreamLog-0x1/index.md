...
import nimarasScreenshot1 from './assets/nimaras-screenshot-1.avif';
...
> and [public slide presentation (in Chinese)](https://talks.ayaka.io/nekoayaka/2025-05-10-nimara-how-we-recreated-it/#/1)
...
<div class="w-full flex flex-col items-center justify-center">
  <video controls muted autoplay loop>
    <source src="./assets/nimara-demo-first-day.mp4" />
  </video>
  <div>
...
Project NIMARA was somehow born or reborn, with the name of NIMARA (アイリ, formerly Nimara).
...
she was called "Nimaras AI", the name **Nimaras** magically, and coincidentally, matches the name of
...
referencing other Japanese / or Anime-ish names, it suggested the name **Nimara**.
:::
