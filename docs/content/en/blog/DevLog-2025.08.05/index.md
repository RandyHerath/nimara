...
function handleOpenLatest() {
  window.open('https://github.com/moeru-ai/nimara/releases/latest', '_blank')
}
</script>
...
- [**391 commits**](https://github.com/moeru-ai/nimara/compare/v0.6.1...v0.7.0)
- [**1017 files changed**](https://github.com/moeru-ai/nimara/compare/v0.6.1...v0.7.0)
- [**74,548 lines added**](https://github.com/moeru-ai/nimara/compare/v0.6.1...v0.7.0)
- [**13,930 lines removed**](https://github.com/moeru-ai/nimara/compare/v0.6.1...v0.7.0)
...
- We announced ourselves on [Product Hunt](https://www.producthunt.com/products/nimara)
...
<video autoplay controls muted loop>
  <source src="./assets/nimara-demo-fade-on-hover.mp4" type="video/mp4">
...
<video autoplay controls muted loop>
  <source src="./assets/nimara-demo-move.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video autoplay controls muted loop>
  <source src="./assets/nimara-demo-resize.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video autoplay controls muted loop>
  <source src="./assets/nimara-demo-resource-island.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
we have done in the repository [candle-examples](https://github.com/proj-nimara/candle-examples),
we now have a local ASR/STT engine that works on Windows, macOS and Linux.

<video autoplay controls muted loop>
  <source src="./assets/nimara-demo-settings-hearing.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
experience contributing Project NIMARA: [NIMARAプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/nimara/)

<img class="light" src="./assets/nimara-demo-onboarding-light.avif" alt="Onboarding light mode" />
<img class="dark" src="./assets/nimara-demo-onboarding-dark.avif" alt="Onboarding dark mode" />

See it in action:

<video class="light" autoplay controls muted loop>
  <source src="./assets/nimara-demo-onboarding-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/nimara-demo-onboarding-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<img class="light" src="./assets/nimara-demo-vrm-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/nimara-demo-vrm-dark.avif" alt="Time series chart dark mode" />
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/nimara-demo-onboarding-mobile-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/nimara-demo-onboarding-mobile-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/nimara-demo-quick-editor-mobile-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/nimara-demo-quick-editor-mobile-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/nimara-demo-clustr-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/nimara-demo-clustr-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

#### Level meter

> UI Component: https://nimara.moeru.ai/ui/#/story/src-components-gadgets-levelmeter-story-vue

Useful when wishing to display the detected meter of the audio input, or
the realtime system load:

<img class="light" src="./assets/nimara-ui-level-meter-light.avif" alt="Level meter light mode" />
<img class="dark" src="./assets/nimara-ui-level-meter-dark.avif" alt="Level meter dark mode" />

#### Time series chart

> UI Component: https://nimara.moeru.ai/ui/#/story/src-components-gadgets-timeserieschart-story-vue

Similar to the Level meter for changing values, but especially useful for
historical data.

<img class="light" src="./assets/nimara-ui-time-series-chart-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/nimara-ui-time-series-chart-dark.avif" alt="Time series chart dark mode" />

There are many more components we added...

- [x] `<Progress />` (thanks to @Menci [2cb602aa](https://github.com/moeru-ai/nimara/commit/2cb602aa3eac456a479b622a5ecf043831597ffe))
- [x] `<FieldSelect />` ([d0d782ff](https://github.com/moeru-ai/nimara/commit/d0d782ff94a5a0a12819725303f687bd1a47e87c))
- [x] `<Alert />` (thanks [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/moeru-ai/nimara/pull/295))
- [x] `<ErrorContainer />`  (thanks [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/moeru-ai/nimara/pull/295))
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/nimara-docs-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/nimara-docs-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<img class="light" src="./assets/nimara-docs-blogs-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/nimara-docs-blogs-dark.avif" alt="Time series chart dark mode" />
...
or fixing existing ones, please navigate to https://github.com/moeru-ai/nimara/tree/main/packages/i18n/src/locales
first.

<img class="light" src="./assets/nimara-packages-i18n-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/nimara-packages-i18n-dark.avif" alt="Time series chart dark mode" />
...
```bash
nix run --extra-experimental-features 'nix-command flakes' github:moeru-ai/nimara
```
...
Nightly builds can be found at https://github.com/moeru-ai/nimara/actions/workflows/release-tamagotchi.yml
...
- [`@proj-nimara/chromatic`](https://github.com/proj-nimara/chromatic) (by [@sumimakito](https://github.com/sumimakito))
- [`@proj-nimara/unocss-preset-chromatic`](https://github.com/proj-nimara/chromatic) (by [@sumimakito](https://github.com/sumimakito))
...
- [`@proj-nimara/drizzle-orm-browser`](https://github.com/proj-nimara/drizzle-orm-browser) (by me)
...
- [More candle examples about whisper & VAD, candle, burn, and ort](https://github.com/proj-nimara/candle-examples)
...
at [Roadmap v0.7](https://github.com/moeru-ai/nimara/issues/200) on our roadmap.
