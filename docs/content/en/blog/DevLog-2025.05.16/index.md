...
the [Project NIMARA](https://github.com/moeru-ai/nimara)!
...
> Find and click the "Nimara Card" button.

<img class="light" :src="CharacterCardMenuLight" alt="screenshot of a menu offers Nimara Card menu button" />
<img class="dark" :src="CharacterCardMenuDark" alt="screenshot of a menu offers Nimara Card menu button" />

> This will bring you to the "Nimara Card editor screen", where you can upload and
> edit your character card for persona customization.

<img class="light" :src="CharacterCardSettingsLight" alt="screenshot of a menu offers Nimara Card menu button" />
<img class="dark" :src="CharacterCardSettingsDark" alt="screenshot of a menu offers Nimara Card menu button" />
...
It's live in our UI component library, you can play around with it: https://nimara.moeru.ai/ui/#/story/src-components-menu-charactercard-story-vue .
...
[WebAI Realtime Voice Chat Examples](https://github.com/proj-nimara/webai-example-realtime-voice-chat),
...
- [VAD](https://github.com/proj-nimara/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad)
- [VAD + ASR](https://github.com/proj-nimara/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad-asr)
- [VAD + ASR + LLM Chat](https://github.com/proj-nimara/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad-asr-chat)
- [VAD + ASR + LLM Chat + TTS](https://github.com/proj-nimara/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad-asr-chat-tts)
...
[Sherpa ONNX powered VAD + ASR + LLM Chat + TTS](https://github.com/proj-nimara/webai-example-realtime-voice-chat/tree/main/apps/sherpa-onnx-demo)

#### Birth of xsAI 🤗 Transformers.js

Because the work we have done for VAD, ASR, Chat, and TTS demos, this gave the
birth of a new side project called [xsAI 🤗 Transformers.js](https://github.com/proj-nimara/xsai-transformers)
...
[https://nimara.moeru.ai/devtools/background-remove](https://nimara.moeru.ai/devtools/background-remove).
...
- New [Tutorial stepper](https://nimara.moeru.ai/ui/#/story/src-components-misc-steppers-steppers-story-vue?variantId=src-components-misc-steppers-steppers-story-vue-0), [File upload](https://nimara.moeru.ai/ui/#/story/src-components-form-input-inputfile-story-vue?variantId=default), and [Textarea](https://nimara.moeru.ai/ui/#/story/src-components-form-textarea-textarea-story-vue?variantId=default) component
- Color issues
- [Typography improved](https://nimara.moeru.ai/ui/#/story/stories-typographysans-story-vue?)

More of the stories can be found at [Roadmap v0.5](https://github.com/moeru-ai/nimara/issues/113)
...
it here too: [https://talks.ayaka.io/nekoayaka/2025-05-10-nimara-how-we-recreated-it/#/1](https://talks.ayaka.io/nekoayaka/2025-05-10-nimara-how-we-recreated-it/#/1)
...
- 92 tasks finished for [Roadmap v0.5](https://github.com/moeru-ai/nimara/issues/113)
  - UI
