...
<p align="center">
  [<a href="https://discord.gg/TgQ3Cu2F7A">Discordサーバーに参加する</a>] [<a href="https:///nimara.moeru.ai">試してみる</a>] [<a href="https://github.com/moeru-ai/nimara/blob/main/README.md">English</a>] [<a href="https://github.com/moeru-ai/nimara/blob/main/docs/README.zh-CN.md">简体中文</a>]
</p>
...
>
> **興味があるなら、ここで自己紹介してみませんか？ [Would like to join part of us to build NIMARA?](https://github.com/moeru-ai/nimara/discussions/33)**
...
- [x] 脳
  ...
  - [x] [Factorio](https://www.factorio.com)をプレイ（進行中ですが、[PoCとデモが利用可能](https://github.com/moeru-ai/nimara-factorio)）
...
- [Awesome AI VTuber](https://github.com/proj-nimara/awesome-ai-vtuber): AI VTuberと関連プロジェクトのキュレーションリスト
...
- [`tstl-plugin-reload-factorio-mod`](https://github.com/moeru-ai/nimara-factorio/tree/main/packages/tstl-plugin-reload-factorio-mod): Factorioモッドの開発時にリロードをサポート
