...
> [!NOTE]
>
> У нас есть целая выделенная организация [@proj-airi](https://github.com/proj-nimara) для всех подпроектов, родившихся из Проекта NIMARA. Проверьте её!
>
...
- [`@proj-airi/drizzle-duckdb-wasm`](https://github.com/moeru-ai/nimara/tree/main/packages/drizzle-duckdb-wasm/README.md): Драйвер Drizzle ORM для DuckDB WASM
- [`@proj-airi/duckdb-wasm`](https://github.com/moeru-ai/nimara/tree/main/packages/duckdb-wasm/README.md): Простой обертка для `@duckdb/duckdb-wasm`
