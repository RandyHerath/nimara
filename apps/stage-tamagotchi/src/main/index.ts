...
electronApp.setAppUserModelId('ai.moeru.nimara')
...
function setupTray(params: {
  ...
  once(() => {
    ...
    appTray.setToolTip('Project NIMARA')
...
async function setupProjectNIMARAServerRuntime() {
...
app.whenReady().then(async () => {
  await setupProjectNIMARAServerRuntime()
