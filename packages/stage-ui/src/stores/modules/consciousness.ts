...
export const useConsciousnessStore = defineStore('consciousness', () => {
  ...
  // State
  const activeProvider = useLocalStorage('settings/consciousness/active-provider', import.meta.env.VITE_CONSCIOUSNESS_PROVIDER as string || '')
  const activeModel = useLocalStorage('settings/consciousness/active-model', import.meta.env.VITE_CONSCIOUSNESS_MODEL as string || '')
