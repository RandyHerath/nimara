...
// For MToon IBL
let nimaraIblProbe: ReturnType<typeof createIblProbeController> | null = null
  ...
  try {
    ...
    try {
      ...
      */
      ...
      if (!nimaraIblProbe && scene.value)
        nimaraIblProbe = createIblProbeController(scene.value)
...
onMounted(async () => {
  ...
  */
  ...
  watch([envSelect, skyBoxIntensity, nprIrrSH], async () => {
    ...
    nimaraIblProbe?.update(mode, skyBoxIntensity.value, nprIrrSH.value ?? null)
  }, { immediate: true })
