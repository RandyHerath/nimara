...
import CircleFadeInAnimation from './assets/circle_blink_in_-_loading_(@proj-nimara).riv'
...
Open sourced on https://github.com/moeru-ai/nimara
`
...
const bootMessages = computed<BootMessage[]>(() => [
  ...
  {
    template: 'Command line: BOOT_IMAGE=/boot/nimara.moeru.ai root=UUID=io.github.moeru-ai.nimara',
    typingSpeed: 1,
  },
  {
